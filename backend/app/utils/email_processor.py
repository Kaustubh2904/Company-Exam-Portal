...
class EmailTemplateProcessor:
    ...
    def get_sample_data() -> Dict[str, str]:
        ...
        return {
            ...
            # FRONTEND_URL already contains /login.
    ...
    def validate_template(
        ...
        invalid_variables = (
            set(variables_used) - valid_variables
        )
    ...
    def format_datetime(dt) -> str:
        ...
        IMPORTANT:
        SQLAlchemy returns naive datetime objects from DB,
        but they represent UTC time. We format them directly
        without conversion.
        """
        ...
        # At this point, dt is a naive datetime object
    ...
    def prepare_email_variables(
        ...
        return {
            ...
            "password": (
                EmailTemplateProcessor.generate_password(
                    drive.title
                )
            ),

            # FRONTEND_URL already contains /login.
            # Do NOT append another /login here.
            "login_url": settings.frontend_url.rstrip("/"),

            "start_time": (
                EmailTemplateProcessor.format_datetime(
                    drive.window_start
                )
            ),

            "duration": str(
                drive.exam_duration_minutes or 60
            ),
        }